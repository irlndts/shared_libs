...
#
# $Id: Constants.pm 386 2011-08-18 19:48:31Z kutterma $
#
# ======================================================================
package SOAP_::Constants;
use strict;
...
%XML_SCHEMAS = ( # The '()' is necessary to put constants in SCALAR form
    URI_1999_SCHEMA_XSD() => 'SOAP_::XMLSchema1999',
    URI_2001_SCHEMA_XSD() => 'SOAP_::XMLSchema2001',
    URI_SOAP11_ENC()      => 'SOAP_::XMLSchemaSOAP1_1',
    URI_SOAP12_ENC()      => 'SOAP_::XMLSchemaSOAP1_2',
);
...
$DEFAULT_PACKAGER = "SOAP_::Packager::MIME";
$DEFAULT_CACHE_TTL = 0;
