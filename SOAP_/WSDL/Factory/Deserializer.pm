package SOAP_::WSDL::Factory::Deserializer;
use strict;
use warnings;
...
my %DESERIALIZER = (
    '1.1' => 'SOAP_::WSDL::Deserializer::XSD',
);
...
SOAP_::WSDL::Factory::Deserializer - Factory for retrieving Deserializer objects

=head1 SYNOPSIS

 # from SOAP_::WSDL::Client:
 $deserializer = SOAP_::WSDL::Factory::Deserializer->get_deserializer({
