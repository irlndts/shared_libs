...
sub find_packager {
    ...
    #        Returns:
    #        * the proper SOAP_::Lite::Packager instance
}
...
sub package {
    # do nothing
    die "SOAP_::Lite::Packager::package() must be implemented";
}
...
package SOAP_::Lite::Packager::MIME;

use strict;
use vars qw(@ISA);
@ISA = qw(SOAP_::Lite::Packager);
...
sub unpackage {
    ...
    if (lc($entity->head->mime_type) eq 'multipart/form-data') {
        ...
        # warn "I am somewhere in the SOAP_::Lite::Packager::MIME code I didn't know I would be in!";
...
package SOAP_::Lite::Packager::DIME;
...
sub new {
    ...
    my $self = SOAP_::Lite::Packager::new(@_);
    bless $self, $classname;
    $SOAP_::Lite::Packager::SUPPORTED_TYPES->{"DIME::Payload"} = 1;
    return $self;
}
