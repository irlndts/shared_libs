...
SOAP_::DateTime - Support for converting dates to C<xsd:dateTime> format
...
C<SOAP_::DateTime> converts dates into the format required by the 
C<xsd:dateTime> type.
